...
contract PuppyRaffleTest is Test {
    ...
    function setUp() public {
        puppyRaffle = new PuppyRaffle(entranceFee, feeAddress, duration, owner);
    }
    ...
    function testChangeFeeAddress() public {
        vm.prank(owner);
        puppyRaffle.changeFeeAddress(newFeeAddress);
        address newAddress = puppyRaffle.feeAddress();
        assertEq(address(newAddress), address(newFeeAddress)); 
    }
}
